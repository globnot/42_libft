...
/*   Updated: 2025/08/04 21:07:32 by aborda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_ft_isalnum(void)
{
	...
	tests[2] = (t_test_int){.actual = '9', .label = "9"};
	tests[3] = (t_test_int){.actual = 'a', .label = "a"};
	...
	while (nb_tests > 0)
	{
		assert_eq_int_logical(isalnum(tests[i].actual),
			ft_isalnum(tests[i].actual), tests[i].label);
		i++;
		nb_tests--;
	}
	printf("----------------------------------------\n");
